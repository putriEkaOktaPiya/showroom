...
if ($_FILES['photo_motor']['name'] != "") {
    ...
    mysqli_query($koneksi, "UPDATE tipe_motor SET photo_motor='$photoname' WHERE id_motor='$id_motor'");
}

// update dengan condition
mysqli_query($koneksi, "UPDATE tipe_motor SET kode_motor='$kode_motor', tipe_motor='$tipe_motor', brand_motor='$brand_motor', photo_motor = '$photoname' WHERE id_motor='$id_motor'");
