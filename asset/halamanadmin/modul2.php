...
<body>
    <nav class="navbar navbar-expand-lg" style="color: #810008; background-color: #DDDDDD;">
      ...
      <div class="mx-5">
        <h3 class="mt-5">Input Data Type Motor </h3>
        ...
        <div class="col">
          <div class="container-fluid">
            <div class="row mt-5">
              <div class="col">
              <form action="action/createmodul2.php" method="POST" enctype="multipart/form-data">
                ...
                <a class="btn btn-danger" href="editmodul2.php" role="button">HALAMAN EDIT</a>
                <table class="table table-bordered table-hover" style="border-style: solid; border-color: #DE2424; border-width: 4px;">
                  ...
                  $data = mysqli_query($koneksi, "SELECT * FROM tipe_motor");
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                          <a href="editmodul2.php?id_motor=<?php echo $row['id_motor'] ?>"><i class="fa-solid fa-pen-clip" style="width: 50px" ></i></a> 
                    ...
                    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                ...
                                <div class="modal-footer">
                                    <a href="modul2.php" class="btn btn-danger">Tidak</a>
