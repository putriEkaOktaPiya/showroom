...
<body>
    <nav class="navbar navbar-expand-lg" style="color: #810008; background-color: #DDDDDD;">
      ...
      <div class="mx-5">
        <h3 class="mt-5">Input data Sepeda Motor Brand Honda</h3>
        ...
        <div class="col">
          <div class="container-fluid">
            <div class="row mt-5">
              <div class="col">
              <form action="action/createmodul4honda.php" method="POST" enctype="multipart/form-data">
                    ...
                    <tr>
                      <td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-75">
                              <input type="text" id="fname" name="id_suzuki" value="">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                              <input type="text" id="fname" name="tahun" value="">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                              <input type="text" id="fname" name="warna" value="">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                              <input type="text" id="lname" name="harga" value="">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-25">
                          ...
                          <div class="row">
                            ...
                            <div class="col-75">
                              <input type="text" id="fname" name="model" value="">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-25">
                ...
                <table class="table table-bordered table-hover" style="border-style: solid; border-color: #DE2424; border-width: 4px;">
                  ...
                  $data = mysqli_query($koneksi, "SELECT * FROM honda_motor");
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                          <a href="editmodul4honda.php?kode=<?php echo $row['kode'] ?>"><i class="fa-solid fa-pen-clip" style="width: 50px" ></i></a> 
                          <a href="deletemodul4honda.php?kode=<?php echo $row['kode'] ?>" data-toggle="modal"
                    ...
                    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                ...
                                <div class="modal-footer">
                                    <a href="modul4honda.php" class="btn btn-danger">Tidak</a>
                                    <a href="deletemodul4honda.php?kode=<?php echo $row['kode'] ?>" class="btn btn-primary">Ya</a>
                                </div>
                    </div>
                    </tr>
                    <?php
