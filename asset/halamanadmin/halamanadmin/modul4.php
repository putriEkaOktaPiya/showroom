...
<body>
    <nav class="navbar navbar-expand-lg" style="color: #810008; background-color: #DDDDDD;">
      ...
      <div class="mx-5">
        <h3 class="mt-5">Input data Sepeda Motor Brand Suzuki</h3>
        ...
        <div class="col">
          <div class="container-fluid">
            <div class="row mt-5">
              <div class="col">
              <form action="action/createmodul4.php" method="POST" enctype="multipart/form-data">
                      ...
                      <td>
                        ...
                        <div class="row">
                          ...
                          <div class="row">
                            ...
                            <div class="col-75">
                              <input type="text" id="fname" name="tahun_motor" value="">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                              <input type="text" id="fname" name="warna_motor" value="">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                              <input type="text" id="lname" name="harga_motor" value="">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                              <select id="tipe_motor" name="tipe_motor">
                          ...
                          <div class="row">
                            ...
                            <div class="col-75">
                              <input type="text" id="fname" name="model_motor" value="">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-25">
                ...
                <br>
                <br>
                <a class="btn btn-danger" href="editmodul4.php" role="button">HALAMAN EDIT</a>
