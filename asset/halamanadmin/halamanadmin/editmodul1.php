        ...
        <div class="col">
          <div class="container-fluid">
            <div class="row mt-5">
              ...
              $q = mysqli_query($koneksi, "SELECT * FROM brand_motor");
              // simpan dalam format array
              $ary = mysqli_fetch_array($q);
              ?>
              <form action="action/edit1.php" method="POST" enctype="multipart/form-data">
              <input type="hidden" name="id_brand" value="<?php echo $ary['id_brand'] ?>">
                      ...
                      <td>
                        ...
                        <div class="container">
                          <div class="row">
                            ...
                            <div class="col-75">
                              <input type="text" id="fname" name="kode_brand" value="<?php echo $ary['kode_brand'] ?>">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                              <select id="select" name="brand" value="<?php echo $ary['brand'] ?>">
                          ...
                          <div class="row">
                            ...
                            <div class="col-75 input-group">
                              <input type="text" class="form-control" name="photo" style="height: 40px;" value="<?php echo $ary['photo'] ?>">
                              <div class="input-group-append">
                                <input type="file" name="photo" class="custom-file-input" id="inputGroupFile02" value="<?php echo $ary['photo'] ?>">
                ...
                <a class="btn btn-danger" href="modul1.php" role="button">TAMBAHKAN DATA</a>
                <table class="table table-bordered table-hover" style="border-style: solid; border-color: #DE2424; border-width: 4px;">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                          <a href="editmodul1.php?id_brand=<?php echo $row['id_brand'] ?>"data-toggle="modal"
                    ...
                    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                ...
                                <div class="modal-footer">
                                    <a href="editmodul1.php" class="btn btn-danger">Tidak</a>
