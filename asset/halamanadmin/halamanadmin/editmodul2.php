        ...
        <div class="col">
          <div class="container-fluid">
            <div class="row mt-5">
              ...
              $q = mysqli_query($koneksi, "SELECT * FROM tipe_motor");
              // simpan dalam format array
              $ary = mysqli_fetch_array($q);
              ?>
              <form action="action/edit2.php" method="POST" enctype="multipart/form-data"> 
              <input type="hidden" name="id_motor" value="<?php echo $ary['id_motor'] ?>">
                ...
                <a class="btn btn-danger" href="modul2.php" role="button">TAMBAHKAN DATA</a>
