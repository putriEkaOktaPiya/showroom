...
$query = "INSERT INTO model_motor (id_motor,kode_motor,tipe_motor,brand_motor,model_motor,photo_motor) VALUES ('$id_motor','$kode_motor','$tipe_motor','$brand_motor','$model_motor','$photo_motor')";
