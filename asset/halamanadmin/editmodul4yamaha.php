...
<body>
    <nav class="navbar navbar-expand-lg" style="color: #810008; background-color: #DDDDDD;">
      ...
      <div class="mx-5">
        <h3 class="mt-5">Edit Sepeda Motor Brand Yamaha</h3>
        ...
        <div class="col">
          <div class="container-fluid">
            <div class="row mt-5">
              ...
              $q = mysqli_query($koneksi, "SELECT * FROM yamaha_motor");
              // simpan dalam format array
              $ary = mysqli_fetch_array($q);
              ?>
              <form action="action/edit4modulyamaha.php" method="POST" enctype="multipart/form-data"> 
                  ...
                  <tbody>
                    <tr>
                      <td>
                        ...
                        <div class="row">
                            <div class="col-25">
                              <label for="fname">ID Yamaha</label>
                            </div>
                            <div class="col-75">
                              <input type="text" id="fname" name="id_yamaha"  value="<?php echo $ary['id_yamaha'] ?>">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                              <input type="text" id="fname" name="thn"  value="<?php echo $ary['thn'] ?>">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                              <input type="text" id="fname" name="wrna"  value="<?php echo $ary['wrna'] ?>">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                              <input type="text" id="lname" name="hrga"  value="<?php echo $ary['hrga'] ?>">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                              <select id="tipe" name="tipem"  value="<?php echo $ary['tipem'] ?>">
                          ...
                          <div class="row">
                            ...
                            <div class="col-75">
                              <input type="text" id="fname" name="modelm"  value="<?php echo $ary['modelm'] ?>">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-25">
