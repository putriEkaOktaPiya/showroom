...
<body>
    <nav class="navbar navbar-expand-lg" style="color: #810008; background-color: #DDDDDD;">
      ...
      <div class="mx-5">
        <h3 class="mt-5">Edit Sepeda Motor Brand Honda</h3>
        ...
        <div class="col">
          <div class="container-fluid">
            <div class="row mt-5">
              ...
              $q = mysqli_query($koneksi, "SELECT * FROM honda_motor");
              // simpan dalam format array
              $ary = mysqli_fetch_array($q);
              ?>
              <form action="action/edit4modulhonda.php" method="POST" enctype="multipart/form-data"> 
              <input type="hidden" name="kode" value="<?php echo $ary['kode'] ?>">
                    ...
                    <tr>
                      <td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-75">
                              <input type="text" id="fname" name="id_honda"  value="<?php echo $ary['id_honda'] ?>">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                              <input type="text" id="fname" name="tahun"  value="<?php echo $ary['tahun'] ?>">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                              <input type="text" id="fname" name="warna"  value="<?php echo $ary['warna'] ?>">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                              <input type="text" id="lname" name="harga"  value="<?php echo $ary['harga'] ?>">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-25">
                            ...
                            <div class="col-75">
                              <select id="tipe" name="tipe"  value="<?php echo $ary['tipe'] ?>">
                          ...
                          <div class="row">
                            ...
                            <div class="col-75">
                              <input type="text" id="fname" name="model"  value="<?php echo $ary['model'] ?>">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-25">
                ...
                <br>
                <br>
                <a class="btn btn-danger" href="modul4honda.php" role="button">TAMBAHKAN DATA</a>
